    ...
    return (
        <CommonHero
            ...
            description="Doruk Biçer, born and raised in Istanbul. I was first impressed by the idea of shaping
                ...
                perspectives. Throughout my journey, I have always aimed to develop myself in different areas and
                tried to explore various design paths through my internships to grow my design perception. During
                those experiences, I have worked with both large and small teams and gained significant experience in
