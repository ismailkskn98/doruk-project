...
function DialogOverlay({ className, ...props }) {
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn("fixed inset-0 isolate z-50 bg-black/15 duration-100data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0", className)}
      {...props}
    />
  );
}
