...
function DialogOverlay({ className, ...props }) {
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn('fixed inset-0 isolate z-50 duration-100 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0', className)}
      {...props}
    />
  );
}
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" asChild>
            <Button variant="ghost" className="absolute top-2 right-2 text-gray-700 cursor-pointer rounded-none bg-white/90" size="icon-sm">
              <XIcon />
