...
// // const BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000';
// const BASE_URL = 'https://dorukbicer.com/businesscards/dorukbicer';
// const QR_URL = `${BASE_URL}/api/vcard`;
...
//     link.href = pngUrl;
//     link.download = 'doruk-bicer-qr.png';
//     link.click();
//   };
...
//           <button onClick={handleDownloadQR} className="px-4 py-2 border border-black text-black text-sm uppercase tracking-wide hover:bg-black hover:text-white transition">
//             QR İndir (PNG)
//           </button>
//         </div>
