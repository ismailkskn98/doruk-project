...
export default function CommonHero({ video, image, alt, title, lightTitle, subtitle, description, sideInfo = [], imageClassName = '', titleLightReverse = false }) {
  return (
    <main className="w-full fluid gridContainer">
      <MotionLeftView className="fluid gridContainer w-full overflow-hidden">
        {video ? (
          <section className="w-full flex items-center justify-center">
            {/* <div className="relative w-full min-[1500px]:aspect-1360/800 min-h-[250px] sm:min-h-80 max-h-[800px] overflow-hidden">
