...
export default function DorukBicerMain() {
  ...
  return (
    <main className="w-full flex flex-col items-start">
      <MotionLeftView className="w-full flex items-end justify-between gap-10 pb-8 pt-4 sm:py-8 lg:py-12.5 overflow-hidden">
        <div className="w-full flex-1 flex flex-col items-start gap-0 lg:gap-2.5">
          <h2 className="font-bold text-xl sm:text-2xl lg:text-[32px] leading-7 text-nowrap">Doruk Bicer</h2>
          <p className="font-light text-lg sm:text-xl lg:text-2xl leading-7 text-nowrap">Designer</p>
        </div>
        <div className="relative w-full max-w-[1000px] aspect-1000/700">
