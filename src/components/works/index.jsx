    ...
    return (
        <main className='w-full'>
            <Tabs defaultValue={selectedCategory} onValueChange={(value) => {
                ...
                <TabsContent value="architecture" className="pt-12.5 pb-30 flex flex-col items-start gap-12.5 max-w-6xl mx-auto">
                ...
                <TabsContent value="graphic" className="pt-12.5 pb-30 flex flex-col items-start gap-12.5 max-w-6xl mx-auto">
