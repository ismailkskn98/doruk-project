    ...
    <main className="w-full fluid gridContainer">
      ...
      <section className="w-full flex items-center justify-between gap-25 py-25">
        <article className="bg-custom-gray p-5 flex-1 w-full flex flex-col items-center gap-4">
          <p className="font-helvetica-neue font-light text-[16px] leading-[1.2] text-black text-center">Average Sound Level In Restaurant Types</p>
        ...
        <article className="bg-custom-gray p-5 flex-1 w-full flex flex-col items-center gap-4">
          <p className="font-helvetica-neue font-light text-[16px] leading-[1.2] text-black text-center">Average Timespan In Restaurant Types</p>
          <SoundChart
            data={[
