...
function Segment({ active = true, className }) {
  return <div className={cn('h-3 border border-[#9a9a9a]', active ? 'bg-linear-to-r from-yellow-300 to-transparent' : 'bg-white', className)} />;
}
...
export default function ModeBar() {
  return (
    <main className="w-full py-6">
      <div className="overflow-x-auto pb-1.5 sm:pb-0">
        <div className="min-w-[560px] max-w-5xl mx-auto">
          <div className="grid grid-cols-[44px_1fr] items-end gap-4 sm:grid-cols-[70px_1fr]">
            <div />
          ...
          <div className="mt-3 space-y-3">
            <div className="grid grid-cols-[60px_1fr] items-center gap-2 sm:gap-4 sm:grid-cols-[70px_1fr]">
