      ...
      <main className="w-full flex flex-col gap-18.75 py-18.75">
        ...
        <section className="w-full">
          <article className="w-full grid grid-cols-2 place-content-stretch items-center gap-10">
            <p className="text-[20px] font-minion-pro">
              When small spaces are combined with traditional architecture, they often result limited functionality and cramped layouts. As a solution, the design coverts rooms into customizable smart
              modules that transforms 49m2 meter space into different rooms. Instead of making the occupant move around the rooms, the projects aim to create the rooms around the user to meet the
              current need. The ultimate ambition is to redefine the environment as an extension of a human.
            </p>
            <div className="relative min-h-150 flex">
              <MotionRightView className="relative w-100 h-100">
                <Image src="/images/projects/the-modular-home-detail-2-lower.webp" alt="The Modular Home Detail 2 Lower" fill className="object-cover w-full h-full" />
              </MotionRightView>
              <MotionLeftView className="absolute bottom-0 right-0 w-100 h-100">
                <Image src="/images/projects/the-modular-home-detail-2-high.webp" alt="The Modular Home Detail 2 High" fill className="object-cover w-full h-full" />
              </MotionLeftView>
            </div>
          </article>
        </section>
        <section className="w-full flex flex-col items-start gap-18.75">
          ...
          <article className="flex flex-col self-end items-start gap-3 max-w-213.5 font-minion-pro text-[20px] leading-7">
            <p>
              The project aims to re-design and update the living spaces to achieve more efficient utilization of space in a small apartment for a single occupant or a couple. The design based on the
              idea of rooms can be treated as individual modules that can be opened and closed, depending on the occupant's current needs. The aim is to reduce the amount of unoccupied volumes while
              also maximizing the usability of the available space.
            </p>
            <p>
              The concept is designed as a home that is 7-meter to a 7-meter single room, where 13 modular units share and transform to get maximum efficiency. The concept creates a flexible and
              customizable living space which is three times more efficient than traditional architecture in small spaces. The design made to allow and adapt to the changing needs and preferences of
              the occupants over time.
            </p>
          </article>
        </section>
        <section className="w-full grid grid-cols-2 place-content-stretch gap-12.5">
          ...
          <article className="flex flex-col items-start gap-10">
            ...
            <div className="flex flex-col items-start gap-10">
              ...
              <p className="font-minion-pro text-[20px] leading-7">
                The kitchen module functions in two modes: fully open as a traditional kitchen, or closed for basic use. It supports users by ordering food based on health data, with deliveries stored
