  ...
  return (
    <main className="w-full fluid gridContainer">
      ...
      */}
      ...
      <section className="fluid gridContainer w-full bg-custom-gray py-12 sm:py-20 md:py-25 md:px-12.5">
        <main className="w-full flex items-center justify-end">
          <article className="w-full flex flex-col items-start gap-4 max-w-187.5 font-minion-pro text-base sm:text-lg lg:text-[20px] leading-6 sm:leading-7">
            <p>
              We live in a culture where we want always more and sometimes even the most of everything. Our goals are to be more even the most: healthy, wealthy, knowledgeable, safe and many
              others. But extremes are same, too cold burs as same as too hot, just in a different way.
            </p>
            <p>
              We strive to create homes where we can feel free, unrestrained but then we cover it high wall to and give up our freed in order to feel secure. And some, tuns it into a prison
              with a context of a freedom.
            </p>
            <p>
              We exercise and eat healthy to stay well and live longer. What if we go too far? An American entrepreneur is spending million dollars a year, takes over 100 pills a day, and
              dedicates 6–7 hours daily to live longer. But is he truly living?
            </p>
            <p>
              What if both extremes are different paths to same result? Is everything is the same as nothing? Might positive infinity and negative infinity be the same end with different
              paths?
            </p>
          </article>
        </main>
